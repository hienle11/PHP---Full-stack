        ...
        <table class="table table-bordered" style="background-color: #fff; margin-top: 2rem;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    value = "<?php echo ($_SESSION['crud']['update'] || isset($_SESSION['crud']['id'])? $_SESSION['crud']['product_name']: "");?>"></td>
                </tr>
            
                <tr>
                    <th scope="row">Description</th>                                                  
                    <td><input type="text" name="descript" class="form-control" placeholder="Product Description"
                    value = "<?php echo ($_SESSION['crud']['update'] || isset($_SESSION['crud']['id'])? $_SESSION['crud']['descript']: "");?>"></td>
                </tr>

                <tr>
                    <th scope="row">Price</th>                                                  
                    <td><input type="text" name="price" class="form-control" placeholder="Product Price"
                    value = "<?php echo ($_SESSION['crud']['update'] || isset($_SESSION['crud']['id'])? $_SESSION['crud']['price']: "");?>"></td>
                </tr>

                <tr>
                    <th scope="row">Quantity</th>                                                  
                    <td><input type="text" name="quantity" class="form-control" placeholder="Product Quantity"
                    value = "<?php echo ($_SESSION['crud']['update'] || isset($_SESSION['crud']['id'])? $_SESSION['crud']['quantity']: "");?>"></td>
                </tr>

                <tr>
                    <th scope="row">Category Id</th>                                                  
                    <td><input type="text" name="category_id" class="form-control" placeholder="Category Id"
                    value = "<?php echo ($_SESSION['crud']['update'] || isset($_SESSION['crud']['id'])? $_SESSION['crud']['category_id']: "");?>"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td >
                        ...
                        src='../../images/<?php echo (($_SESSION['crud']['update'] || isset($_SESSION['crud']['id']) && isset($_SESSION['crud']['image_uri']))? $_SESSION['crud']['image_uri']: "default.png");?>' ></div>
